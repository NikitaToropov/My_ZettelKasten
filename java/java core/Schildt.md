...
* ```java.io```
  * базовый ввод/вывод
  * включая файловый ввод/вывод

### Основы ввода вывода

* консольный ввод/вывод - старье
* большинство приложение вместо этого используют
  * UI (AWT/Swing/JavaFX)
  * веб приложения

#### Потоки ввода-вывода
 
- это абстракция для поставки и потребления информации
- все потоки ввода/вывода ведут себя одинаково
  - не нужно разбираться в способах организации ввода/вывода
    - файл
    - диск
    - ввод с клавиатуры
- в java определены иерархией классов в ```java.io```

#### Потоки ввода-вывода байтов и символов

* _потоки ввода/вывода символов_ `Java 1.1`
* в основе байтовые _потоки ввода/вывода_

#### Классы потоков ввода/вывода байтов

* В основе иерархии абстрактные `InputStream` и `OutputStream`
* В них определены основны методы `read()` и `write()`
