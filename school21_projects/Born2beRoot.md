...
- [ ] Sudo
  ...
  - [ ] проверить существует ли файл для хранения логов sudo
  - [ ] проверить логирование sudo
- [ ] UFW
  - [ ] проверить что UFW установлена на ВМ
  - [ ] проверить что работает корректно
  - [ ] объяснить что такое UFW и зачем он нужен
  - [ ] показать список активных правил, он должен содержать правило для порта 4242
  - [ ] добавить правило для 8080
  - [ ] удалить
